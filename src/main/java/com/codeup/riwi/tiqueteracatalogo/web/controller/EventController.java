...
public class EventController {
    ...
    @Operation(
            ...
            description = "Retorna una lista completa de todos los eventos registrados en el sistema"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = "[{\"id\":1,\"name\":\"Concierto Rock\",\"description\":\"Gran concierto\",\"eventDate\":\"2025-12-15T20:00:00\",\"venueId\":1,\"capacity\":1000,\"price\":80000.0}]"
                            )
                    )
            )
    })
    ...
    @Operation(
            ...
            description = "Retorna un evento específico buscado por su identificador único"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            examples = @ExampleObject(
                                    value = "{\"timestamp\":\"2025-10-28T10:30:00\",\"status\":404,\"error\":\"Not Found\",\"message\":\"Evento con ID 999 no encontrado\",\"path\":\"/api/events/999\"}"
                            )
                    )
            )
    })
    ...
    @Operation(
            ...
            description = "Crea un nuevo evento en el sistema con la información proporcionada"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "201",
            ...
            @ApiResponse(
                    ...
                    content = @Content(
                            ...
                            schema = @Schema(implementation = ErrorResponse.class),
                            examples = @ExampleObject(
                                    value = "{\"timestamp\":\"2025-10-28T10:30:00\",\"status\":400,\"error\":\"Bad Request\",\"message\":\"Error de validación en los datos enviados\",\"path\":\"/api/events\",\"details\":[\"name: El nombre del evento es obligatorio\"]}"
                            )
                    )
            )
    })
    ...
    public ResponseEntity<EventoResponse> createEvent(
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    ...
                    required = true,
                    content = @Content(
                            schema = @Schema(implementation = EventoRequest.class),
                            examples = @ExampleObject(
                                    value = "{\"name\":\"Concierto Rock\",\"description\":\"Gran concierto de rock\",\"eventDate\":\"2025-12-15T20:00:00\",\"venueId\":1,\"capacity\":1000,\"price\":80000.00}"
                            )
                    )
            )
    ...
    @Operation(
            ...
            description = "Actualiza completamente la información de un evento existente"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
    ...
    public ResponseEntity<EventoResponse> updateEvent(
            ...
            @PathVariable Long id,
            @io.swagger.v3.oas.annotations.parameters.RequestBody(
                    description = "Nuevos datos del evento",
                    required = true,
                    content = @Content(
                            schema = @Schema(implementation = EventoRequest.class),
                            examples = @ExampleObject(
                                    value = "{\"name\":\"Concierto Rock Actualizado\",\"description\":\"Descripción actualizada\",\"eventDate\":\"2025-12-15T20:00:00\",\"venueId\":1,\"capacity\":1200,\"price\":90000.00}"
                            )
                    )
            )
            @Valid @RequestBody EventoRequest request) {
    ...
    @Operation(
            ...
            description = "Elimina permanentemente un evento del sistema"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "204",
    ...
    @Operation(
            ...
            description = "Retorna todos los eventos programados para un venue específico"
    )
    @ApiResponses(value = {
            @ApiResponse(
                    responseCode = "200",
